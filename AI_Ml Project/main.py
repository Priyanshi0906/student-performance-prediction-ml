...
# 3.8 Boxplot — Overall Score by Pass/Fail
plt.figure(figsize=(6, 4))
df.boxplot(column='overall_score', by='pass_fail')
plt.title('Overall Score by Pass/Fail')
plt.suptitle('')
plt.xlabel('0 = Fail  |  1 = Pass')
plt.ylabel('Overall Score')
plt.tight_layout()
plt.savefig('Overall_Score_by_Pass_Fail.png')
plt.show()
